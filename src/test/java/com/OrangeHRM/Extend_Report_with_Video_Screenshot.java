...
public class Extend_Report_with_Video_Screenshot {

	DateFormat dateFormat = new SimpleDateFormat("dd-MM-yy-HH-mm-ss");
	Date date = new Date();
	String filepath = System.getProperty("user.dir");
	String VideoFolder = filepath + "\\Script_Video\\";
	// String VideoFolder = "D:\\Selenium_Jenkins_Integration\\VideoFolder\\";
	String VideoFile = "TestVideo_" + dateFormat.format(date);
	...
	@BeforeTest
	public void startReport() throws IVideoRecorderrException {
		...
		extent.addSystemInfo("Host Name", "Welcome to Extent Report").addSystemInfo("User Name", "Dixit")
				.addSystemInfo("OS", System.getProperty("os.name")).addSystemInfo("Chrome", "91");
	...
	@Test
	public void OrangeHRM_Login() throws ATUTestRecorderException {
	...
	public void getResult(ITestResult result) throws Exception {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			ExtentReport_WithScreenshot_and_Video.getScreenhot(driver,result.getName());
			//String screenshotPath = BaseClass.getScreenhot(driver, result.getName());
			// To add it in the extent report
			logger.log(LogStatus.FAIL, logger.addScreenCapture(screenshotPath));// This
																				// is
																				// for
																				// Screenshot
			logger.log(LogStatus.INFO,
					"<a href='" + VideoFolder + VideoFile + ".mov" + "'>" + result.getName() + "</a>");
	...
	@AfterTest
	public void endReport() throws ATUTestRecorderException {
